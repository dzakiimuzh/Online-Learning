<?php 
    ...
    $queryDetail = mysqli_query($conn, "SELECT * FROM tbl_tugas INNER JOIN tbl_guru ON tbl_tugas.id_guru = tbl_guru.id_user WHERE tbl_tugas.id_tugas = '$idTugas' AND tbl_tugas.id_guru = '$idUser2'");
            ...
            <div class="col-md-12">
                <div class="card card2">
                    ...
                    <div class="btn-grup mt-5 d-flex align-items-center justify-content-center">
                        ...
                        <a href="kunciJawaban.php?idTugas=<?= $idTugas ?>&materi=<?= $row['materi'] ?>&kelas=<?= $kelas2 ?>" class="btn btn-soal mr-3" style="width: 90%;">Kunci Jawaban</a>
                        <?php endif; ?>
                        <?php if( $row['jenis_soal'] == 'Essay' ) :?>
                        <a href="dataKoreksi.php?idTugas=<?= $idTugas ?>&kelas=<?= $kelas2 ?>" class="btn btn-soal mr-3" style="width: 90%;">Koreksi</a>
                        <?php endif; ?>
                        <a href="editTugas.php?idTugas=<?= $row['id_tugas'] ?>&kelas=<?= $kelas2 ?>" class="btn btn-edit btn-success p-2 mr-2"><i class="fas fa-edit"></i></a>
                        <a href="deleteTugas.php?idTugas=<?= $row['id_tugas'] ?>&kelas=<?= $kelas2 ?>" class="btn btn-edit btn-danger p-2"><i class="fas fa-trash-alt"></i></a>
                    </div>
                </div>
            </div>
        </div>
