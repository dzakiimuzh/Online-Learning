<?php 
    ...
    function upload() {
        ...
        move_uploaded_file($tmpName, '../assets/img_guru/' . $namaFileBaru);
    ...
    $ambilKelas = mysqli_query($conn, "SELECT * FROM tbl_guru WHERE id_user ='$id'");

    $ambil = mysqli_fetch_assoc($ambilKelas);
    $kelas2 = $ambil['kelas'];
    $kelas3 = explode(',', $kelas2);

    $imgP = mysqli_query($conn, "SELECT * FROM tbl_guru WHERE id_user = '$id'")->fetch_assoc();

    $data = mysqli_query($conn, "SELECT * FROM tbl_guru INNER JOIN users ON tbl_guru.id_user = users.id_user WHERE tbl_guru.id_user = '$id'")->fetch_assoc();
    ...
    if( isset($_POST['ubah']) ) {
        ...
        $cek = mysqli_query($conn, "SELECT password FROM users WHERE password = '$pw' AND role = 'guru'");
        ...
        if( $_FILES['img']['error'] == 4 ) {
            ...
            if( !$imgLama = 'profile.svg' ) {
                ...
                unlink('../assets/img_guru/' . $imgLama);

            }

        }

        $query = mysqli_query($conn, "UPDATE tbl_guru SET img = '$img' WHERE id_user = '$id'");
            ...
            <div class="col-md-12">
                <div class="card card2">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <img id="preview" src="../assets/img_guru/<?= $data['img']; ?>" width="90"
