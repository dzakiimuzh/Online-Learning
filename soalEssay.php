<?php 
    ...
    $qSoal = mysqli_query($conn, "SELECT * FROM tbl_soal_essay WHERE id_tugas = '$idTugas'");
    $qSoal2 = mysqli_query($conn, "SELECT * FROM tbl_soal_essay WHERE id_tugas = '$idTugas'");
    ...
    if( isset($_POST['selesai']) ) {
        ...
        while( $nomor <= $jumlahSoal ) {
            ...
            $s = mysqli_fetch_assoc($qSoal2);

            $idEssay = $s['id_essay'];

            $jawaban = $_POST['jawaban' . $nomor];
            
            $query2 = mysqli_query($conn, "INSERT INTO tbl_jawaban_essay VALUES('', '$idUser', '$idEssay', '$jawaban')");
        ...
        $queryInsert = mysqli_query($conn, "INSERT INTO tbl_nilai VALUES('', '$idUser', '$idTugas', '$jumlahSoal', '-', '-', 'Belum di koreksi', '$date', '$jam')");
        

        $query3 = mysqli_query($conn, "INSERT INTO detail_tgs_essay VALUES('', '$idUser', '$idTugas', '$date', 'Belum di koreksi')");
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="soal mt-5 ml-4">
                                    <div class="detail-soal d-flex">
                                        <h6 class="no"><?= $no++; ?>.</h6>
                                        <h6 class="ml-2 tSoal"><?= $soal['soal'] ?></h6>
                                    </div>
                                    <div class="jawaban ml-3">
                                        <div class="form-group ml-3" style="width: 50%;">
                                            <textarea name="jawaban<?= $no2++; ?>" class="form-control input2"
