...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <?php 
            ...
            $jumlah_data = count(query("SELECT * FROM mapel"));
            $total_halaman = ceil($jumlah_data / $batas);
        
            $nomor = $halaman_awal+1;
        
            $mapel = mysqli_query($conn, "SELECT * FROM mapel LIMIT $halaman_awal, $batas");

            if( isset($_POST['cari']) ) {

                $keyword = $_POST['keyword'];

                $jumlah_data = count(query("SELECT * FROM mapel WHERE mapel LIKE '%$keyword%'"));
                $total_halaman = ceil($jumlah_data / $batas);

                $mapel = mysqli_query($conn, "SELECT * FROM mapel WHERE mapel LIKE '%$keyword%' LIMIT $halaman_awal, $batas");
                    ...
                    <div class="col-md-12">
                        <div class="card p-4">
                            ...
                            <div class="aksi d-flex justify-content-between">
                                <a href="tambahMapel.php" class="btn btn-primary mb-3">Tambah Data</a>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $m['mapel'] ?></td>
                                        <td>
                                            <a href="editMapel.php?id=<?= $m['id_mapel'] ?>"
                                                class="btn btn-success">Edit</a>
                                            <a href="deleteMapel.php?id=<?= $m['id_mapel'] ?>"
