<?php 
    ...
    if( isset($_POST['tambah']) ) {
        ...
        $queryInput = mysqli_query($conn, "INSERT INTO mapel VALUES('', '$mapel')");
        ...
        if( $queryInput ) {
            ...
            echo "
                ...
                <script>
                    alert('Tambah mapel gagal');
                    document.location.href = 'tambahMapel.php';
                </script>
                            ...
                            <form action="" method="POST">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleFormControlInput1"
                                        placeholder="Masukkan mapel" name="mapel">
                                </div>
