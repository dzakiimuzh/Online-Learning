...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <?php 
            ...
            $jumlah_data = count(query("SELECT * FROM tbl_guru"));
            $total_halaman = ceil($jumlah_data / $batas);
        
            $nomor = $halaman_awal+1;
        
            $guru = mysqli_query($conn, "SELECT * FROM tbl_guru LIMIT $halaman_awal, $batas");

            if( isset($_POST['cari']) ) {

                $keyword = $_POST['keyword'];

                $jumlah_data = count(query("SELECT * FROM tbl_guru WHERE nama LIKE '%$keyword%' OR mapel LIKE '%$keyword%' OR kelas LIKE '%$keyword%'"));
                $total_halaman = ceil($jumlah_data / $batas);

                $guru = mysqli_query($conn, "SELECT * FROM tbl_guru WHERE nama LIKE '%$keyword%' OR mapel LIKE '%$keyword%' OR kelas LIKE '%$keyword%' LIMIT $halaman_awal, $batas");
