...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <?php 
            ...
            $jumlah_data = count(query("SELECT * FROM kelas"));
            $total_halaman = ceil($jumlah_data / $batas);
        
            $nomor = $halaman_awal+1;
        
            $kelas = mysqli_query($conn, "SELECT * FROM kelas LIMIT $halaman_awal, $batas");

            if( isset($_POST['cari']) ) {

                $keyword = $_POST['keyword'];

                $jumlah_data = count(query("SELECT * FROM kelas WHERE kelas LIKE '%$keyword%'"));
                $total_halaman = ceil($jumlah_data / $batas);

                $kelas = mysqli_query($conn, "SELECT * FROM kelas WHERE kelas LIKE '%$keyword%' LIMIT $halaman_awal, $batas");
                    ...
                    <div class="col-md-12">
                        <div class="card p-4">
                            ...
                            <div class="aksi d-flex justify-content-between">
                                <a href="tambahKelas.php" class="btn btn-primary mb-3">Tambah Data</a>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $k['kelas'] ?></td>
                                        <td>
                                            <a href="editKelas.php?id=<?= $k['id_kelas'] ?>"
                                                class="btn btn-success">Edit</a>
                                            <a href="deleteKelas.php?id=<?= $k['id_kelas'] ?>"
